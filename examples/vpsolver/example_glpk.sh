...
echo "* > vbp2afg instance.vbp graph.afg                       *"
echo "* > afg2mps graph.afg model.mps                          *"
echo "* > vpsolver_glpk.sh --mps model.mps --afg graph.afg   *"
echo "**********************************************************"
vbp2afg instance.vbp $TMP_DIR/graph.afg
afg2mps $TMP_DIR/graph.afg $TMP_DIR/model.mps
vpsolver_glpk.sh --mps $TMP_DIR/model.mps --afg $TMP_DIR/graph.afg

echo -e "\n\n"

echo "**********************************************************"
echo "* Example 6:                                             *"
echo "* > ./vpsolver_glpk.sh --vbp instance.vbp              *"
echo "**********************************************************"
vpsolver_glpk.sh --vbp instance.vbp
